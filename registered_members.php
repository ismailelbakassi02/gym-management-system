						...
						<table class="table table-bordered table-condensed table-hover">
							...
							<!-- 		<td class="">
									...
									<td class="text-center">
										<?php
              $time=strtotime($row['end_date'])-strtotime($row['start_date'])-(strtotime(date("Y-m-d"))-strtotime($row['start_date'])+2);
...
<script>
	...
	$('.delete_member').click(function(){
		uni_modal("Are you sure to delete this topic?","delete_member",[$(this).attr('data-id')],'mid-large')
	})
