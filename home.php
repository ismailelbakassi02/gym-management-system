                            ...
                            <div class="card">
                                <div class="card-body bg-danger">
                                    <div class="card-body text-white">
                                        <span class="float-right summary_icon"><i class="fa fa-female"></i></span>
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM members where gender = 'female'")->num_rows; ?>
                                        </b></h4>
                                        <p><b>member of women </b></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body bg-dark">
                                    <div class="card-body text-white">
                                        <span class="float-right summary_icon"><i class="fa fa-male"></i></span>
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM members where gender = 'male'")->num_rows; ?>
                                        </b></h4>
                                        <p><b>member of men</b></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body bg-info">
                                    <div class="card-body text-white">
                                        ...
                                        <p><b>Total des plans d'inscription</b></p>
                                    </div>
                                </div>
                            </div>
                        </div>
